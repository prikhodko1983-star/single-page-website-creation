        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://vk.ru/vekpam" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-80" title="ВКонтакте">
              <img src="https://cdn.poehali.dev/projects/522c6aad-08c3-4e8e-ac23-7f70b446ea53/bucket/d013d239-bfaa-4a1b-a14c-18c8d933ee0d.png" alt="ВКонтакте" width={36} height={36} className="rounded-lg" />
            </a>
