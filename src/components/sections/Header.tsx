      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://max.ru/im?phone=89960681168" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity rounded-lg overflow-hidden flex items-center justify-center" title="Написать в Max">
              <MaxIcon size={34} />
            </a>
          </div>
        </div>
