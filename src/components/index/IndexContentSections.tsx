...
export default function IndexContentSections({
  ...
  return (
    <>
      <section id="services" className="py-16 md:py-24 relative overflow-hidden bg-[#1a181459]" style={{ background: '#1A1814' }}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <BeforeAfterSlider
                  beforeSrc="https://cdn.poehali.dev/projects/522c6aad-08c3-4e8e-ac23-7f70b446ea53/bucket/de725b64-6c1c-4cae-8359-86617a51a775.jpg"
                  afterSrc="https://cdn.poehali.dev/projects/522c6aad-08c3-4e8e-ac23-7f70b446ea53/bucket/064c9023-256a-4b19-b152-aca5e42b321b.jpg"
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-8">
            <Card className="bg-card border-border overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-4">
                  <div className="text-sm text-center text-muted-foreground">Создадим композицию по описанию</div>
                </div>
              </CardContent>
            </Card>
