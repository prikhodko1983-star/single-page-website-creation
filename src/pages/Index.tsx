                ...
                <div className="max-w-2xl space-y-2 md:space-y-4 lg:space-y-6">
                  ...
                  <div className="space-y-1.5 md:space-y-2 lg:space-y-3">
                    <div className="flex items-center gap-2 md:gap-3 text-white/90">
                      ...
                      <span className="text-xs md:text-base lg:text-lg">Выберите форму и дизайн</span>
                    </div>
                    <div className="flex items-center gap-2 md:gap-3 text-white/90">
                      <svg className="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 text-[#D4A855] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="text-xs md:text-base lg:text-lg">Добавьте фото и надпись</span>
                    </div>
                    <div className="flex items-center gap-2 md:gap-3 text-white/90">
                      <svg className="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 text-[#D4A855] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="text-xs md:text-base lg:text-lg">Посмотрите, как будет выглядеть памятник</span>
                    </div>
                    <div className="flex items-center gap-2 md:gap-3 text-white/90">
                      <svg className="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 text-[#D4A855] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="text-xs md:text-base lg:text-lg">Без регистрации и бесплатно</span>
                    </div>
                  </div>
