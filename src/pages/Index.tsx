          ...
          >
            ...
            <div className="relative z-10 min-h-[400px] md:min-h-[500px] lg:min-h-[600px] p-6 md:p-10 lg:p-12 flex items-center">
              <div className="max-w-2xl space-y-5 md:space-y-6">
                ...
                <button className="bg-[#D4A855] hover:bg-[#C49745] text-black font-medium px-7 py-4 md:px-8 md:py-5 rounded-lg text-base md:text-lg lg:text-xl transition-all duration-300 group-hover:scale-105 flex items-center gap-2">
