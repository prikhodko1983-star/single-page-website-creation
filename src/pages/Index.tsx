      ...
      <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white py-4 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-sm mt-1 opacity-90">
            Все материалы ознакомительные и не являются офертой. Использование сайта означает согласие с условиями и Политикой конфиденциальности.
          </p>
        </div>
      </div>
      ...
      <section className="py-8 md:py-14 bg-[#111111]">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <button className="inline-flex items-center gap-2 hover:bg-[#C49745] text-black font-oswald font-semibold px-6 py-3 rounded-lg text-sm md:text-base transition-all bg-[#e89c1f]"
              onClick={() => navigate('/constructor')}
